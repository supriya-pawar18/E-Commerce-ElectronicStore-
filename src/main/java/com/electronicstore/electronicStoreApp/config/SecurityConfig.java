package com.electronicstore.electronicStoreApp.config;
...
public class SecurityConfig {
    ...
    @Autowired
    private JwtAuthicationEntryPoint authenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .permitAll()
                .antMatchers(String.valueOf(HttpMethod.DELETE), "/user/delete/")
                .hasRole("ADMIN")
                .anyRequest()
                .authenticated()
                .and()
